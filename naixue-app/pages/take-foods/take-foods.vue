						...
						<list-cell :hover="false" padding="50rpx 30rpx">
							<view class="w-100 d-flex flex-column">
								<view
									...
									v-if="orderCurrent.order_type == 0"
								>
									...
									>
										...
										<view class="steps__text-column">
											<view
												...
												:class="{ active: orderCurrent.status >= 2 }"
											>
											...
											>
												...
												<view class="steps__text-column-item-text">
													{{ orderCurrent.order_type == 1 ? '已送达' : '请取餐' }}
												</view>
												<view class="steps__column-item-line bg-transparent"></view>
											</view>
										</view>
								...
								>
									<view
										...
										v-for="(good, index) in orderCurrent.goodsInOrder"
										:key="index"
									>
